...
- **Done:** **Invoice PDF:** `GET /billing/invoices/:id/pdf` (pdfkit; org name, tenant, lines, total, notes) + **Download PDF** on invoice detail. Not a jurisdiction-specific tax invoice — operational summary only.
